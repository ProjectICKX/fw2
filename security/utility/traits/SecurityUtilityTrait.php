...
trait SecurityUtilityTrait {
	public static function GetDefaultSanitizeTags () {
		return [
			'script',
			'style',
		];
	...
	public static function GetDefaultSanitizeAttributes () {
		return [
			'*'	=>	[
				'style',
				'animationend',
	...
	public static function GetSanitizeCrLfCodeSet () {
	...
	public static function GetSanitizeControlCodeSet () {
	...
	public static function GetSanitizeUnicodeControlCodeSet () {
